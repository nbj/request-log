                ...
                <div class="pt-5">
                    ...
                    <div class="pb-5">
                        <div class="mr-5">
                            ...
                            @if(!$isEnabled)
                                <p class="text-danger float-left mt-4 font-weight-bold">Logging disabled</p>
                            @endif
                        ...
                        <form method="get" class="float-right form-inline">
                            <div class="form-group mr-5">
                                <label class="form-check-label mr-3">
                                    Path: <input class="form-control ml-2" type="text" name="path_regex" style="width: 250px" placeholder="% (SQL LIKE)" value="{{ old("path_regex") }}">
                                </label>
                                <label class="form-check-label mr-3">
