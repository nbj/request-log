                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text">
                            <table class="table-hover w-100 table-vertical">
                                ...
                                <tr>
                                    <td>Query:</td>
                                    <td><x-request-log-pretty-print :data="$requestLog->query_string"/></td>
                                </tr>
                                <tr>
                                    <td>Date:</td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text">
                            <table class="table-hover w-100 table-vertical">
                                ...
                                <tr>
                                    <td>Header:</td>
                                    <td><x-request-log-pretty-print :data="$requestLog->request_headers"/></td>
                                </tr>
                                <tr>
                                    <td>Body:</td>
                                    <td><x-request-log-pretty-print :data="$requestLog->request_body"/></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text">
                            <table class="table-hover w-100 table-vertical">
                                ...
                                <tr>
                                    <td>Header:</td>
                                    <td><x-request-log-pretty-print :data="$requestLog->response_headers"/></td>
                                </tr>
                                <tr>
                                    <td>Exception:</td>
                                    <td><x-request-log-pretty-print :data="$requestLog->response_exception"/></td>
                                </tr>
                                <tr>
                                    <td>Body:</td>
                                    <td><x-request-log-pretty-print :data="$requestLog->response_body"/></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
